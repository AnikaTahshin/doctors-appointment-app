...
<br className="hidden sm:block" /> schedule your appointment hassle-free.</p>
        ...
        <a className="flex items-center bg-white px-8 py-3 rounded-full text-gray-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300" href="#speciality">Book Appointment  <img className="w-3 ml-2" src={assets.arrow_icon} alt="" /></a>
        </div>
